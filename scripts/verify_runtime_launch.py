...
def main() -> None:
    ...
    for tree_name in ("docs", "dist"):
        ...
        assert launch["fielded_100"] is False
        assert launch["never_fielded_100"] is True
        ...
        assert cite["fielded_100"] is False
        assert cite["never_fielded_100"] is True
        ...
        for path, value in walk_bools(cite):
            if path.endswith("fielded_100") or path.endswith("never_fielded_100"):
                if path.endswith("fielded_100") and not path.endswith("never_fielded_100"):
        ...
        for blob, label in ((llms, "llms"), (llms_full, "llms-full"), (ai, "ai")):
            ...
            assert "never fielded_100" in blob.lower() or "Never fielded_100" in blob, label
        ...
        for payload, label in ((mcp, "mcp"), (wk_mcp, "well-known-mcp")):
            ...
            assert server["fielded_100"] is False, label
        ...
        assert wk["runtime_sot"]["fielded_100"] is False
