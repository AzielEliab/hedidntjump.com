...
Supplied plates on the main paper (cropped to the clipping or certificate, not WSU/catalog chrome): Marion’s death certificate with inquiry 11 (injuries inconsistent with a five-story fall); Frances’s certificate (Involutional Melancholia) with inquiry 22; bogeyman disguise; “‘Who’s Crazy?’ Will Be Topic For Zioncheck”; “Playboy Subdued After Battle”; “Last Picture of Congressman and Bride”; Hoover-era “Zioncheck Arrested” crop (Volume I, PDF p. 3); escort still on inquiry 01 (Aziel captions William Bishop, Capitol police; volumes do not print that name; LOC LCCN 2016878217); FBI FOIPA closing plate on inquiry 21 (full packet on the FOIA paper).
